...
mysqldump -i --complete-insert -u alumne -pkeiL2lai -r /home/joan/romanic_200302.sql -v romanic
'''
...
def preparar_consulta(str):
	str = str.lower()
	paraules = ['capella de ',u'parròquia de ', u'església de ', 'sant ', 'santa ', ' de la ', ' dels ', ' de ', ' la ', ' del ', 'ermita ', 'st. ', 'sta. ','st ','sta ', ' d\'', ' l\'']
